...
/**
 * PaintAppLambda is a simple JavaFX application that allows users to draw shapes (circles and squares)
 * on a canvas using different colors. The application uses lambda expressions to handle button clicks
 * and mouse events for drawing shapes.
 * @author jenil
 */
public class PaintAppLambda extends Application {
    ...
    public void start(Stage stage) throws Exception {
        ...
        stage.setTitle("Paint App with Lambda Expressions");
        ...
        // Set the action for the Circle button using a lambda expression
        circleButton.setOnAction(e -> selectedShape = "Circle");

        // Create a Button for selecting the Square shape
        Button squareButton = new Button("Square");
        // Set the action for the Square button using a lambda expression
        squareButton.setOnAction(e -> selectedShape = "Square");
